package br.com.biancabezerra.todolist.task;
...
import br.com.biancabezerra.todolist.utils.Utils;
...
public class TaskController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity udpate(@RequestBody TaskModel taskModel, HttpServletRequest request, @PathVariable UUID id ){
        ...
        if(!task.getIdUser().equals(idUser)){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Sem permissao");
        }
